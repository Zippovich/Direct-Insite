			...
			<?php if ( classic_show_share_single() ) { ?>					
				<div class="aligncenter">
					...
					<div id="share-placeholder">
						...
						<div class="pop-inner">
							<ul>
								<li id="twitter"><a target="_blank" class="no-ajax"href="http://m.twitter.com/home/?status=<?php echo urlencode( html_entity_decode( wptouch_get_title() . ' -> ' . get_permalink() ) ); ?>"><?php _e( "Share on Twitter", "wptouch-pro" ); ?></a></li>
